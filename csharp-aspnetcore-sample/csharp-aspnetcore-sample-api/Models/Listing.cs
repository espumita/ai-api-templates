...
public enum Category {
    ...
    [EnumMember(Value = "Home & Garden")] HomeAndGarden,
    [EnumMember(Value = "Motors")] Motors,

    [EnumMember(Value = "Collectibles & Art")]
    CollectiblesAndArt,
    [EnumMember(Value = "Sporting Goods")] SportingGoods,
    [EnumMember(Value = "Toys & Hobbies")] ToysAndHobbies,
...
public class Listing {
    ...
    [Required] public Price Price { get; set; } = new();
...
public class Filter {
    ...
    [Required] public object Value { get; set; } = string.Empty;
}
